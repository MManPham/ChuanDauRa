...
public class testCDR_MH {
    ...
    public testCDR_MH(String chuanDauRaMonHoc, float ketQua, List<CDR_KH_KQ> chuanDauRaKhoaHoc) {
    ...
    public testCDR_MH(String chuanDauRaMonHoc, float ketQua) {
        this.chuanDauRaMonHoc = chuanDauRaMonHoc;
        this.ketQua = ketQua;
